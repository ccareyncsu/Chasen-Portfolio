  ...
  return(
    <div className='about-section' id='about'>
      ...
      <div className='col-10 center about-text'>
        <p className='left'>Software Developer. Biochemist. Weightlifter. After studying and working as Biochemist for a little under ten years, 
        ...
        <p className='left'>I just recently finished the Engineering Immersion Program at Thinkful.  It was an amazing experience to say the least.
          ...
          everyday, but unlike with biochemistry, I am able to harness my undeniable love for making things.
